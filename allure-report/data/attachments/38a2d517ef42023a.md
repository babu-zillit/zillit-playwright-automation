...
- Name: Upload media tests >> upload image
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/upload-mediaTest.spec.js:78:3
...
Error: locator.waitFor: Error: strict mode violation: locator('//div[@class=\'dropDown\']') resolved to 3 elements:
    ...
    3) <div class="dropDown">…</div> aka locator('div:nth-child(4) > .dropDown')
...
Call log:
  - waiting for locator('//div[@class=\'dropDown\']') to be visible
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/upload-mediaTest.spec.js:83:24
```
...
- main:
  ...
  - paragraph: Hello, this is an automated test!
  - paragraph
  - text: Jun 11, 2025 at 12:42 PM
  - img "down"
  - text: B Babu Android (1st Ac - A camera)
  - paragraph: Hello, this is an automated test!
  - paragraph
  - text: Jun 11, 2025 at 01:02 PM
  - img "down"
  - text: B Babu Android (1st Ac - A camera)
  - img "Image"
  - text: File Size - 200.06 KB Jun 11, 2025 at 01:02 PM
  - img "down"
  - button
  - button "paper-clip":
    - img "paper-clip"
