...
```
Error: locator.click: Error: strict mode violation: locator('text=Your Documents') resolved to 2 elements:
    1) <h2 class="font-semibold text-lg uppercase">Standard Forms & Contracts and Your Documents</h2> aka getByRole('heading', { name: 'Standard Forms & Contracts' })
    2) <button id="your_documents_button" class="w-[150px] py-2 font-semibold false false">Your Documents</button> aka getByRole('button', { name: 'Your Documents' })

Call log:
  - waiting for locator('text=Your Documents')

    at ContractSignature.yourDocuments (/Users/babuyadav/Documents/zillit-playwright-automation/src/pages/contract-signature.js:216:56)
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/contract-signatureTest.spec.js:68:40
```
...
- main:
  ...
  - paragraph: ACTION
  - paragraph: Test Form
  - paragraph: Aug 22, 2025 at 01:36 PM
...
> 216 |         await this.page.locator('text=Your Documents').click();
      |                                                        ^ Error: locator.click: Error: strict mode violation: locator('text=Your Documents') resolved to 2 elements:
