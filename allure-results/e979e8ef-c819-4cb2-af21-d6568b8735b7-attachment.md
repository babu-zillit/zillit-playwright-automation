...
Call log:
  - waiting for locator('text=External user information has been added successfully.') to be visible
    ...
    at ExternalUser.addUser (/Users/babuyadav/Documents/zillit-playwright-automation/src/pages/external-user.js:49:26)
...
```ts
  ...
  43 |         await this.page.locator('//span[@class="ant-select-selection-item"]').last().click();
