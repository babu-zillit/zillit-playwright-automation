...
- Name: Casting >> Selects Tab >> verify casting upload, open the folder, and view the image
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/21_castingTest.spec.js:36:9
...
Call log:
  - waiting for locator('text=/Zl automation55/i').first()
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/21_castingTest.spec.js:23:27
```
