...
- Name: Accounts >> Send Document >> verify the delete reply
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/09_accountTest.spec.js:129:9

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('text=Comment deleted successfully!') resolved to 2 elements:
    1) <span>Comment deleted successfully!</span> aka getByText('Comment deleted successfully!').first()
    2) <span>Comment deleted successfully!</span> aka getByText('Comment deleted successfully!').nth(1)
...
Call log:
  ...
  - waiting for locator('text=Comment deleted successfully!')
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/09_accountTest.spec.js:130:13
```
...
- main:
  ...
  - tabpanel "General"
  - paragraph:
    - button "Pramod Androi..."
  - button "plus-circle":
    - img "plus-circle"
  - text: B Babu Web (1st assistant accountant)
  - img "image Thumbnail"
  - text: "babu.pdf To: Pramod Android (Writer) File Size - 274.38 KB Sep 29, 2025 at 01:55 PM"
  - img "down"
  - button
  - button "paper-clip":
    - img "paper-clip"
