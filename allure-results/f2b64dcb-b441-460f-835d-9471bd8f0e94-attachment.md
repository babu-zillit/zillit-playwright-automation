...
Call log:
  - waiting for locator('//span[@class="ant-select-selection-item"]').nth(6)

    at ExternalUser.addUser (/Users/babuyadav/Documents/zillit-playwright-automation/src/pages/external-user.js:44:86)
...
- dialog "Add User":
  ...
  - text: Male * TYPE
  - combobox "* TYPE"
  - text: Crew Member * Department Direction
  - combobox "* Department"
  - text: Direction * Designation
...
> 44 |         await this.page.locator('//span[@class="ant-select-selection-item"]').nth(6).click();
     |                                                                                      ^ Error: locator.click: Target page, context or browser has been closed
