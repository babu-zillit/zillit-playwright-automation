...
- Name: Continuity Script Notes >> Selected Takes >> verify the delete reply
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/19_continuity-script-notesTest.spec.js:58:9
...
Call log:
  ...
  - waiting for locator('text=Comment deleted successfully!')
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/19_continuity-script-notesTest.spec.js:60:13
```
...
- dialog:
  ...
  - img "image Thumbnail"
  - text: babu.pdf File Size - 274.38 KB Sep 29, 2025 at 04:50 PM B Babu Web(Caterers)
  - paragraph: This is message
  - text: Edited Sep 29, 2025 at 04:50 PM
  - img "down"
  - img "down"
  - button
  - button "paper-clip":
