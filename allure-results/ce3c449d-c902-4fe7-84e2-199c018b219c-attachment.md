...
- Name: Upload media tests >> upload video
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/upload-mediaTest.spec.js:88:3
...
Call log:
  - waiting for locator('//div[@class=\'dropDown\']') to be visible
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/upload-mediaTest.spec.js:93:24
```
...
- main:
  ...
  - img
  - img
  - text: File Size - 748.54 KB Jun 11, 2025 at 01:03 PM
  - img "down"
  - button
  - button "paper-clip":
    - img "paper-clip"
