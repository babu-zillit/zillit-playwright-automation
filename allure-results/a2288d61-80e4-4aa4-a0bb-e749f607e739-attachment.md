...
Call log:
  - waiting for locator('#common_add_signature_modal_open_button')
    ...
    at ContractSignature.yourDocuments (/Users/babuyadav/Documents/zillit-playwright-automation/src/pages/contract-signature.js:228:76)
...
- main:
  - button:
    - img
  - heading "Test Form" [level=2]
  - button "Add to Your Documents"
  - paragraph: Page
  - paragraph: 1 / 2
  - button [disabled]:
    - img
  - button:
    - img
  - text: "SACHITA Email: ysachita07 @gmail.com Mobile: + 91 9307919415 I have 3 + years of IT Experience in Software Testing exposed to Automation Testing approaches for various Web based applications. Involved in offshore assignments for providing software services to the finest global organizations. • 2.5 years of hands - on experience in Selenium Web driver with Java and SQL and rest of all in Manual Testing. • Currently Working with S . M Web Solution s Pvt. Ltd . • Hybrid Data Driven Framework with customization according to project requirement and situation. • Extensive Experience in implementation of Selenium’s Page Object Model Automation to achieve high reusability and modularity in Automation Scripts. • Worked on Product Requirement Analysis and reviews. Creation, execution and reviews of Test Automation Strategies, plans & Scenarios. • Worked extensively in Agile methodology and SDLC experience across multiple types of testing – Functional, Regression, Browser compatibility testing. • Experience in creating Page Object Model based automation framework using selenium and TestNG. Extensive Experience in Planning, Designing, Creation and maintenance of Automation Frameworks using TestNG, Customized Framework with various type of user friendly reporting including Extent Report with snapshot, TestNG Reporting with Snapshot. Professional Expertise ● Build and maintain automation scripts independently by leveraging deep understanding of automaton concepts, various testing tools and scripting approaches. Knowledge of various frameworks like Keyword & Hybrid Framework. Implement and introduce new features to the existing automation framework available in the project. ● Experience on developing and maintaining automation frameworks. ● Execute Testing, log defects and report the progress to Test Lead/ Manager. ● More than years of experience in selenium automation tools. ● Hands on experience in developing frameworks using TestNG, Maven, S . M Web Solution s Pvt. Ltd. QA Engineer"
```
