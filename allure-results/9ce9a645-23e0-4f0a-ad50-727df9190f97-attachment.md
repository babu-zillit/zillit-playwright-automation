...
- Name: Accounts >> Send Audio >> verify the delete reply
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/9accountTest.spec.js:160:9
...
Call log:
  ...
  - waiting for locator('text=Comment deleted successfully!')
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/9accountTest.spec.js:161:13
```
...
- main:
  ...
  - text: 00:05 / 00:00 Aug 26, 2025 at 12:58 PM File Size - 160.54 KB
  - paragraph
  - text: B Babu Web(1st assistant accountant)
  - paragraph: This is message
  - text: Edited Aug 26, 2025 at 12:59 PM
  - img "down"
  - img "down"
  - button
  - button "paper-clip":
