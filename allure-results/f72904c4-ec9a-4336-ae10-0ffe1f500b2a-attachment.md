...
- Name: Bulletin >> Send Message >> verify edit the message
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/3bulletinTest.spec.js:39:9
...
Call log:
  - waiting for locator('//div[@class=\'dropDown\']') to be visible
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/3bulletinTest.spec.js:40:31
```
...
- main:
  ...
  - img "Image"
  - text: File Size - 200.06 KB Aug 26, 2025 at 12:02 PM
  - img "down"
  - text: B Babu Web (Caterers)
  - img "Image"
  - text: Caption :- This is image reply File Size - 200.06 KB Aug 26, 2025 at 12:02 PM
  - img "down"
  - text: B Babu Web (Caterers)
  - paragraph: Hello How are you
  - paragraph
  - text: Aug 26, 2025 at 12:15 PM
  - img "down"
  - button
  - button "paper-clip":
    - img "paper-clip"
