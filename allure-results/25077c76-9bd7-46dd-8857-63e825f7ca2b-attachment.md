...
- Name: Continuity Script Notes >> Daily Progress Notes >> verify the delete the reply message successfully
- Location: /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/continuity-script-notesTest.spec.js:171:9
...
Call log:
  ...
  - waiting for locator('text=Comment deleted successfully!')
    ...
    at /Users/babuyadav/Documents/zillit-playwright-automation/src/tests/continuity-script-notesTest.spec.js:173:13
```
...
- dialog:
  ...
  - paragraph
  - text: Edited Aug 22, 2025 at 04:52 PM B Babu Web(Caterers)
  - paragraph: This is message
  - text: Edited Aug 22, 2025 at 04:52 PM
  - img "down"
  - img "down"
  - button
  - button "paper-clip":
